...
function Uc(e, n, t, r, l, o, u, i, s) {
  (xt = !1), (Rr = null), Mc.apply(Fc, arguments);
}
...
function bo(e, n, t, r) {
  if (Dr) {
    var l = co(e, n, t, r);
    if (l === null) Il(e, n, r, Mr, t), Yu(e, r);
...
function Lf(e, n) {
  if (Mn)
    return e === "compositionend" || (!ru && Ms(e, n))
      ? ((e = Is()), (Sr = eu = en = null), (Mn = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Me], delete n[Vt], delete n[go], delete n[Xf], delete n[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ha(e, n, t) {
  for (var r = (e.mode & 1) !== 0; S !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && o !== null ? ((o.return = l), (S = o)) : Di(e);
  }
}
function Di(e) {
  for (; S !== null; ) {
...
function je(e, n, t, r) {
  if (50 < Tt) throw ((Tt = 0), (Mo = null), Error(y(185)));
  Gt(e, t, r),
    (!(R & 2) || e !== J) &&
...
function Rd() {
  return j.jsx("h1", { children: "Catatan Belanja 📝" });
}
function jd({ onAddItem: e }) {
  const [n, t] = _n.useState(""),
    [r, l] = _n.useState(1),
    o = [...Array(10)].map((i, s) =>
      j.jsx("option", { value: s + 1, children: s + 1 }, s + 1)
    );
  function u(i) {
    if ((i.preventDefault(), !n)) return;
    const s = { name: n, quantity: r, checked: !1, id: Date.now() };
    e(s), console.log(s), t(""), l(1);
  }
  return j.jsxs("form", {
    className: "add-form",
    onSubmit: u,
    children: [
      j.jsx("h3", { children: "Hari ini belanja apa kita?" }),
      j.jsxs("div", {
        children: [
          j.jsx("select", {
            value: r,
      ...
      j.jsx("button", { children: "Tambah" }),
    ],
  });
}
function Od({ item: e, onDeleteItem: n, onToggleItem: t }) {
  return j.jsxs(
    "li",
    {
      children: [
        ...
        j.jsxs("span", {
          style: e.checked ? { textDecoration: "line-through" } : {},
          children: [e.quantity, " ", e.name],
        }),
        j.jsx("button", { onClick: () => n(e.id), children: "×" }),
      ],
    },
    e.id
  );
}
function Id({ items: e, onDeleteItem: n, onToggleItem: t, onClearItems: r }) {
  const [l, o] = _n.useState("input");
  let u;
  switch (l) {
    case "name":
      u = e.slice().sort((i, s) => i.name.localeCompare(s.name));
      break;
    case "checked":
      u = e.slice().sort((i, s) => i.checked - s.checked);
      break;
    default:
      u = e;
      break;
  ...
  return j.jsxs(j.Fragment, {
    children: [
      j.jsx("div", {
        ...
        children: j.jsx("ul", {
          children: u.map((i) =>
            j.jsx(Od, { item: i, onDeleteItem: n, onToggleItem: t }, i.id)
          ),
        }),
      }),
      j.jsxs("div", {
        ...
        children: [
          j.jsxs("select", {
            ...
            children: [
              j.jsx("option", {
                value: "input",
                children: "Urutkan berdasarkan urutan input",
              }),
              j.jsx("option", {
                value: "name",
                children: "Urutkan berdasarkan nama barang",
              }),
              j.jsx("option", {
                value: "checked",
                children: "Urutkan berdasarkan ceklis",
              }),
            ],
          }),
          j.jsx("button", { onClick: r, children: "Bersihkan Daftar" }),
        ],
      }),
    ],
  });
...
function Dd({ items: e }) {
  if (e.length === 0)
    return j.jsx("footer", {
      className: "stats",
      children: "Daftar belanja masih kosong",
    });
  const n = e.length,
    t = e.filter((l) => l.checked).length,
...
const Md = [];
function Fd() {
  const [e, n] = _n.useState(Md);
  function t(u) {
    n([...e, u]);
  }
  function r(u) {
    n((i) => i.filter((s) => s.id !== u));
  }
  function l(u) {
    n((i) => i.map((s) => (s.id === u ? { ...s, checked: !s.checked } : s)));
  }
  function o() {
    n([]);
  }
...
Ql.createRoot(document.getElementById("root")).render(
  j.jsx(wc.StrictMode, { children: j.jsx(Fd, {}) })
);
